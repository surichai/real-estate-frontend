<template>
    <div class="col-xl-6">
        <div class="card">
            ...
            border: 1px solid #22479C !important;
            }
            .b-t-primary {
            border-top: 1px solid #22479C !important;
            }
            .b-b-primary {
            border-bottom: 1px solid #22479C !important;
            }
            .b-l-primary {
            border-left: 1px solid #22479C !important;
            }
            .b-r-primary {
            border-right: 1px solid #22479C !important;
            }
            .b-secondary {
